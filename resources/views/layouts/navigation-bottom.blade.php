...
<nav class="bottom-nav" id="bottomNav">
    ...
    <a href="{{ route('mahasiswa.tugas.index') }}"
        class="bottom-nav-item {{ request()->routeIs('mahasiswa.tugas.*') ? 'active' : '' }}">
        <i class="bi bi-journal-text"></i>
        <span>Tugas</span>
    </a>
    <a href="{{ route('mahasiswa.myclass') }}"
        class="bottom-nav-item {{ request()->routeIs('mahasiswa.myclass', 'mahasiswa.kelas.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('logout') }}" class="nav-signout" id="desktopExit" title="Sign out"
