...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white dark:bg-[#171d25] rounded-2xl shadow-sm border border-slate-100 dark:border-[#344150] p-6">
        <h3 class="text-lg font-semibold text-ink dark:text-white mb-4 border-b border-slate-100 dark:border-[#344150] pb-2">Informasi Pribadi & Keahlian</h3>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class="text-base text-ink dark:text-white font-medium">
                    @if(Auth::user()->laboranProfile && Auth::user()->laboranProfile->nip)
                        {{ Auth::user()->laboranProfile->nip }}
                    @else
            ...
            <div class="sm:col-span-2">
                <p class="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">Spesialisasi Lab</p>
                <p class="text-base text-ink dark:text-white font-medium">
                    @if(Auth::user()->laboranProfile && Auth::user()->laboranProfile->spesialisasi_lab)
                        {{ Auth::user()->laboranProfile->spesialisasi_lab }}
                    @else
                        <span class="text-slate-400 italic">Belum diisi</span>
                    @endif
                </p>
