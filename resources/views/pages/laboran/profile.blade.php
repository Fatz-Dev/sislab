    ...
    <div class="bg-white dark:bg-[#171d25] rounded-2xl shadow-sm border border-slate-100 dark:border-[#344150] p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class="text-base text-ink dark:text-white font-medium">{{ Auth::user()->laboranProfile->nip ?? '-' }}</p>
            </div>
            <div>
            ...
            <div class="sm:col-span-2">
                ...
                <p class="text-base text-ink dark:text-white font-medium">{{ Auth::user()->laboranProfile->spesialisasi_lab ?? '-' }}</p>
            </div>
        </div>
    </div>
</div>
