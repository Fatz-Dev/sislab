...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <nav class="flex text-sm text-slate-500 dark:text-white mb-1" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="{{ route('dosen.rekap.index') }}" class="inline-flex items-center dark:text-white dark:hover:text-green-200 transition-colors">
        ...
        <div class="flex flex-wrap items-center gap-2">
            <a href="{{ route('dosen.rekap.export-absensi', $kelas->id) }}" class="px-3.5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg shadow-sm text-xs sm:text-sm font-medium transition-colors flex items-center gap-1.5">
                <i class="bi bi-file-earmark-excel"></i> Export Excel Presensi
            </a>
            <a href="{{ route('dosen.rekap.export-nilai', $kelas->id) }}" class="px-3.5 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-lg shadow-sm text-xs sm:text-sm font-medium transition-colors flex items-center gap-1.5">
                <i class="bi bi-file-earmark-spreadsheet"></i> Export Excel Nilai
            </a>
            <a href="{{ route('dosen.rekap.cetak', $kelas->id) }}" target="_blank" class="px-3.5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-sm text-xs sm:text-sm font-medium transition-colors flex items-center gap-1.5">
                <i class="bi bi-printer"></i> Cetak Dokumen
            </a>
            <a href="{{ route('dosen.rekap.export-pdf', $kelas->id) }}" class="px-3.5 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-lg shadow-sm text-xs sm:text-sm font-medium transition-colors flex items-center gap-1.5">
    ...
    <div class="bg-white dark:bg-[#171d25] rounded-xl shadow-sm border border-slate-200 dark:border-[#344150] overflow-hidden print:shadow-none print:border-none print:mb-6">
        <div class="p-5 border-b border-slate-200 dark:border-[#344150] bg-slate-50/50 dark:bg-[#29323e] flex flex-col sm:flex-row sm:items-center justify-between gap-2 print:bg-transparent print:border-black">
            ...
            <a href="{{ route('dosen.rekap.export-absensi', $kelas->id) }}" class="text-xs font-semibold text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 inline-flex items-center gap-1 print:hidden">
    ...
    <div class="bg-white dark:bg-[#171d25] rounded-xl shadow-sm border border-slate-200 dark:border-[#344150] overflow-hidden print:shadow-none print:border-none">
        <div class="p-5 border-b border-slate-200 dark:border-[#344150] bg-slate-50/50 dark:bg-[#29323e] flex flex-col sm:flex-row sm:items-center justify-between gap-2 print:bg-transparent print:border-black">
            ...
            <a href="{{ route('dosen.rekap.export-nilai', $kelas->id) }}" class="text-xs font-semibold text-teal-600 hover:text-teal-700 dark:text-teal-400 inline-flex items-center gap-1 print:hidden">
