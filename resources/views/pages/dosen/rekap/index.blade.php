            ...
            <nav class="flex text-sm text-slate-500 dark:text-white mb-1" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="{{ route('dosen.dashboard') }}" class="inline-flex items-center dark:text-white dark:hover:text-green-200 transition-colors">
                    ...
                    @forelse($kelas as $k)
                        <tr class="hover:bg-slate-50 dark:hover:bg-[#29323e] transition-colors">
                            <td class="px-6 py-4">
                                ...
                                <div class="text-xs text-slate-500 dark:text-slate-400 mt-1">Laboran: {{ $k->laboran->name ?? '-' }}</div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('dosen.rekap.show', $k->id) }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-900/40 rounded-lg text-sm font-medium transition-colors border border-green-200 dark:border-green-800">
