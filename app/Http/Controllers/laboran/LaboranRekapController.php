...
class LaboranRekapController extends Controller
{
    /**
     * Menampilkan daftar kelas untuk direkap (Laboran).
     */
    public function index()
    {
        ...
        return view('pages.laboran.rekap.index', compact('kelas', 'semesterAktif'));
    }

    /**
     * Menampilkan detail rekapitulasi per kelas.
     */
    public function show($id)
    {
        ...
        return view('pages.laboran.rekap.show', compact('kelas'));
    }
